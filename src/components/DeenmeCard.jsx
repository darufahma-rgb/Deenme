...
const DEENME_EDGE_URL = 'https://uhpsopminpewirkmloiv.supabase.co/functions/v1/get-deenme-pin';
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 13, color: '#888', marginBottom: 20, lineHeight: 1.6 }}>
        ...
        Gunakan kode di bawah untuk masuk.
      </div>
      ...
      >
        {pin}
        <span style={{ fontSize: 14, color: '#555', fontFamily: 'sans-serif', fontWeight: 400, letterSpacing: 0 }}>
          {copied ? '✓ Disalin' : '📋'}
        </span>
      </div>

      {/* CTA — bug diperbaiki: tag <a> yang hilang di file asli */}
      <a
        href={DEENME_URL}
        target="_blank"
      ...
      <div style={{ fontSize: 11, color: '#444', marginTop: 10, textAlign: 'center' }}>
        Kode ini unik untukmu · jangan bagikan ke orang lain
      </div>
    </div>
  );
}
